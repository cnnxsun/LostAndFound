...
class othersLostFound extends StatefulWidget {

  @override
  _MyothersLostFoundState createState() => _MyothersLostFoundState();
}

class _MyothersLostFoundState extends State<othersLostFound> {
...
class OptionButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (selectedOption == label) {
      textColor = label == 'Lost' ? const Color(0xFFFF0E0E) : const Color(0xFF5DB075);
          ...
          Row(
            children: [
              const SizedBox(
                ...
                height: 50,
                child: CircleAvatar(
                  backgroundImage: AssetImage('assets/tararin.png'),
                ),
              ),
            ...
            children: [
              Row(
                children: [
                  ...
                  SizedBox(width: 62),
                  Text('Strommy', style: TextStyle(color: Colors.black)),
                  Spacer(),
                  Text('Missing!!!',
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 69),
                  Text('Bird', style: TextStyle(color: Colors.black)),
                ],
              ),
              Row(
                children: [
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 65),
                  Text('White/Yellow', style: TextStyle(color: Colors.black)),
                ],
              ),
              Row(
                children: [
          ...
          Row(
            children: [
              const SizedBox(
                ...
                height: 50,
                child: CircleAvatar(
                  backgroundImage: AssetImage('assets/Fai.png'),
                ),
              ),
              const SizedBox(width: 10),
              Expanded(
            ...
            children: [
              Row(
                children: [
                  Text('Name: ', style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF26117A))), // Added 3 tabs
                  SizedBox(width: 62),
                  Text('Heatblast', style: TextStyle(color: Colors.black)),
                  Spacer(),
                  Text('found!!!',
              ...
              Row(
                children: [
                  ...
                  Text('Type: ', style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF26117A))), 
                  SizedBox(width: 69),
                  Text('Horse', style: TextStyle(color: Colors.black)),
                ],
              ),
              Row(
                children: [
              ...
              Row(
                children: [
                  ...
                  Text('Color: ', style: TextStyle(fontWeight: FontWeight.bold,color: Color(0xFF26117A))),
                  SizedBox(width: 65),
                  Text('Dark Brown', style: TextStyle(color: Colors.black)),
                ],
              ),
              Row(
                children: [
